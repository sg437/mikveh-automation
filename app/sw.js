...
const CACHE = 'mikveh-app-v9';
const FILES = ['./', './index.html', './app.js', './forms.js', './talk.js', './work.js', './media.js', './edit.js', './perms.js', './auth.js', './config.js', './hebdate.js', './data.js', './manifest.json'];
